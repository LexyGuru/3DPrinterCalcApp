...
## v3.0.4 (2025) - 🔧 热修复：翻译和语言更改修复

### 🐛 错误修复

#### 翻译和语言更改改进
- **加密数据文本国际化** - 硬编码的 "TITKOSITOTT ADATOK" 文本现在在所有语言中正确显示
- **语言更改后自动更新数据** - 所有数据自动以新语言保存
- **语言更改时线材颜色修复** - 线材颜色现在在语言更改时自动更新，无论是在输入字段中还是在列表/表格中

### 📝 技术细节

- **版本已更新**: `Cargo.toml`, `tauri.conf.json`, `frontend/src/utils/version.ts` → `3.0.4`
- **`Filaments.tsx` 修改**: 添加了语言更改时自动更新颜色的功能
