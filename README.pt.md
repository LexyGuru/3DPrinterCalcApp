...
- 🔒 **Criptografia de dados de clientes** - Criptografia AES-256-GCM para dados de clientes, proteção de dados em conformidade com GDPR/UE, proteção opcional por senha
